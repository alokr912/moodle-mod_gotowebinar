...
if ($id) {
    ...
    $gotowebinar = $DB->get_record('gotowebinar', ['id' => $cm->instance], '*', MUST_EXIST);
}
$course = $DB->get_record('course', ['id' => $cm->course], '*', MUST_EXIST);

$meeturl = '';
$gototrainingdownloads = [];
...
$PAGE->set_url('/mod/gotowebinar/view.php', ['id' => $cm->id]);
...
$table->head = [get_string('pluginname', 'mod_gotowebinar')];
$table->headspan = [2];
$table->size = ['30%', '70%'];
